...
public class PeopleConstants {
    ...
    public static final String PERSON_ALREADY_EXISTS_MESSAGE = "A person already exists with the provided document";
    public static final String MAIL_ALREADY_EXISTS_MESSAGE = "A person already exists with the provided mail";
